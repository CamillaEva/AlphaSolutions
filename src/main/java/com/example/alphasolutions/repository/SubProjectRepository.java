...
public class SubProjectRepository {
    ...
    public SubProject readSubProjectById(int subProjectID) {
        String sql = "SELECT SP.SUBPROJECTID, SP.NAME, SP.DESCRIPTION, SP.STARTDATE, SP.ENDDATE, SP.TIMEEST, T.TASKID AS TID, T.NAME AS TNAME, T.DESCRIPTION AS TDESCRIPTION, T.STARTDATE AS TSTARTDATE, T.ENDDATE AS TENDDATE, T.TIMEEST AS TTIMEEST FROM SUBPROJECT SP " +
